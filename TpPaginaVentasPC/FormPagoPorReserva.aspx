<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Logueo.Master" CodeBehind="FormPagoPorReserva.aspx.vb" Inherits="TpPaginaVentasPC.FormPagoPorReserva"
theme="Skin1" %>
...
<div>
        ...
        <table style="width:100%; height: 318px;">
            ...
            <tr>
                ...
                <td class="style3">
                    <asp:Button ID="btnRealizarCompra" runat="server" Text="Realizar reserva" 
